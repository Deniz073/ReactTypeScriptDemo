...
export default function Categories({ categories }: Props) {
  ...
  function handleEdit(id: number) {
    ...
    if (!category) {
      console.error("Categorie item not found");
      return;
    }
  ...
  function handleDelete(id: number) {
    const CategorieItem = categories.find((item) => item.id === id);

    if (!CategorieItem) {
      console.error("CategorieItem item not found");
      return;
    }

    router.delete(route("categories.destroy", CategorieItem.id), {
      onSuccess: () => {
        reset();
        toggleShow();
      }
    ...
    <div>
      ...
      >
        <MDBModalDialog>
          <MDBModalContent>
            <MDBModalHeader>
              <MDBModalTitle>Categorie</MDBModalTitle>
              <MDBBtn
                className="btn-close"
                color="none"
                onClick={toggleShow}
